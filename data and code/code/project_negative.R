rm(list=ls()) 
setwd("F:\\4Data Mining\\project\\aclImdb\\train\\neg") 
data <- readLines("F:\\4Data Mining\\project\\aclImdb\\train\\neg\\file.txt")  
x<-c(1,1)

a=sample(c(1:12500),size=2500)
...
train_negative=train_negative[a,]
data = data.frame(x = doc.mds[, 1], y = doc.mds[, 2], topic = train_negative$V2, id = row.names(train_negative))
